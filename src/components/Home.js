...
import './Home.css'
const carturl="http://localhost:8600/cart"
const Home = (props) => {
                    ...
                    return (
                        <>
                                    ...
                                    <tr>
                                        ...
                                        <td>{item.name} </td>
                                        <td>{item.username}</td>
                                        <td><Link to='/view'><button style={{ backgroundColor: 'blue', color: 'white', borderRadius: '10px', borderStyle: 'none', alignItems: 'center' }}>save</button></Link> </td>
                                        <td>{item.email}</td>
                                    </tr>
